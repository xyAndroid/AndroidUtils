...
import com.xy.lib.utils.XAndroidUtils;
...
public class XSpUtils {
     ...
     */
    public void init() {
        init(XSpConstant.DEFAULT_SP_NAME);
    }
    ...
    public void init(DefaultValueBuilder defaultValueBuilder) {
        init(XSpConstant.DEFAULT_SP_NAME, defaultValueBuilder);
    }
    ...
    public SharedPreferences initSharedPreferences() {
        return getBestSharePreferences(XAndroidUtils.app(), defaultSpFileName);
    }
    ...
    private SharedPreferences getSharePreferences(String name) {
        ...
        return XAndroidUtils.app().getSharedPreferences(name, Context.MODE_PRIVATE);
    }
    ...
    public void putString(String spFileName, String key, String value) {
        getEditor(XAndroidUtils.app(), spFileName).putString(key, value).apply();
    }
    ...
    public void putInt(String key, Integer value) {
        getEditor(XAndroidUtils.app(), defaultSpFileName).putInt(key, value).apply();
    }
    ...
    public void putInt(String name, String key, Integer value) {
        getEditor(XAndroidUtils.app(), name).putInt(key, value).apply();
    }
    ...
    public void putBoolean(String key, boolean value) {
        getEditor(XAndroidUtils.app(), defaultSpFileName).putBoolean(key, value).apply();
    }
    ...
    public void putBoolean(String name, String key, boolean value) {
        getEditor(XAndroidUtils.app(), name).putBoolean(key, value).apply();
    }
    ...
    public void putFloat(String key, float value) {
        getEditor(XAndroidUtils.app(), defaultSpFileName).putFloat(key, value).apply();
    }
    ...
    public void putFloat(String name, String key, float value) {
        getEditor(XAndroidUtils.app(), name).putFloat(key, value).apply();
    }
    ...
    public void putLong(String key, long value) {
        getEditor(XAndroidUtils.app(), defaultSpFileName).putLong(key, value).apply();
    }
    ...
    public void putLong(String name, String key, long value) {
        getEditor(XAndroidUtils.app(), name).putLong(key, value).apply();
    }
    ...
    public void removeKey(String spFileName, String key) {
        getEditor(XAndroidUtils.app(), spFileName).remove(key).apply();
    }
    ...
    public void clearSpFile(String spFileName) {
        getEditor(XAndroidUtils.app(), spFileName).clear().apply();
    }
    ...
    public void clearSpFile() {
        getEditor(XAndroidUtils.app(), defaultSpFileName).clear().apply();
    }


    public static class DefaultValueBuilder {

        private String defaultStringValue = XSpConstant.DEFAULT_STRING_VALUE;
        private int defaultIntValue = XSpConstant.DEFAULT_INT_VALUE;
        private boolean defaultBooleanValue = XSpConstant.DEFAULT_BOOLEAN_VALUE;
        private float defaultFloatValue = XSpConstant.DEFAULT_FLOAT_VALUE;
        private long defaultLongValue = XSpConstant.DEFAULT_LONG_VALUE;
