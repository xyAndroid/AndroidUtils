...
public class XIntentUtils {
    ...
    public static Intent getInstallAppIntent(final String filePath) {
        return getInstallAppIntent(XFileUtils.getFileByPath(filePath));
    }
    ...
    public static Intent getInstallAppIntent(final File file) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            uri = FileProvider.getUriForFile(XAndroidUtils.app(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String pkgName) {
        String launcherActivity = XActivityUtils.getLauncherActivity(pkgName);
        if (XStringUtils.isSpace(launcherActivity)) return null;
    ...
    public static Intent getShareImageIntent(final String content, final String imagePath) {
        if (XStringUtils.isSpace(imagePath)) return null;
    ...
    public static Intent getShareImageIntent(final String content, final File image) {
        ...
        return getShareImageIntent(content, XUriUtils.file2Uri(image));
    }
    ...
    public static Intent getShareImageIntent(final String content, final List<File> images) {
        ...
        for (File image : images) {
            ...
            uris.add(XUriUtils.file2Uri(image));
        }
