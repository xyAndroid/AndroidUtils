...
public class XActivityUtils {
    ...
    public static void addActivityLifecycleCallbacks(final Activity activity,
        ...
        XActivityLifecycleUtils.getInstance().addActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity) {
        XActivityLifecycleUtils.getInstance().removeActivityLifecycleCallbacks(activity);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity,
                                                        final XActivityLifecycleCallbacks callbacks) {
        XActivityLifecycleUtils.getInstance().removeActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    static Context getTopActivityOrApp() {
        if (XAppUtils.isAppForeground()) {
            Activity topActivity = getTopActivity();
            return topActivity == null ? XAndroidUtils.app() : topActivity;
        } else {
            return XAndroidUtils.app();
        }
    }
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, XAndroidUtils.app().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, XAndroidUtils.app().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(XAndroidUtils.app().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return XActivityLifecycleUtils.getInstance().getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(XAndroidUtils.app().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        if (XStringUtils.isSpace(pkg)) return "";
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(XAndroidUtils.app().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return XActivityLifecycleUtils.getInstance().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = XActivityLifecycleUtils.getInstance().getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = XActivityLifecycleUtils.getInstance().getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(XAndroidUtils.app(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(XAndroidUtils.app(), clz));
    }
    ...
    private static boolean startActivity(final Intent intent,
        ...
        if (!isIntentAvailable(intent)) {
            XLog.e("ActivityUtils", "intent is unavailable");
            return false;
        }
        if (!(context instanceof Activity)) {
    ...
    private static boolean startActivityForResult(final Intent intent,
        ...
        if (fragment.getActivity() == null) {
            XLog.e("ActivityUtils", "Fragment " + fragment + " not attached to Activity");
            return false;
        }
        if (options != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
