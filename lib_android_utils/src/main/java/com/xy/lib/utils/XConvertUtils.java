...
import com.xy.lib.constant.XMemoryConstants;
import com.xy.lib.constant.XTimeConstants;
...
public class XConvertUtils {
    ...
    public static byte[] hexString2Bytes(String hexString) {
        if (XStringUtils.isSpace(hexString)) return new byte[0];
    ...
    public static Bitmap bytes2Bitmap(final byte[] bytes) {
        return XImageUtils.bytes2Bitmap(bytes);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap) {
        return XImageUtils.bitmap2Bytes(bitmap);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap, final Bitmap.CompressFormat format, int quality) {
        return XImageUtils.bitmap2Bytes(bitmap, format, quality);
    }
    ...
    public static Drawable bytes2Drawable(final byte[] bytes) {
        return XImageUtils.bytes2Drawable(bytes);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable) {
        return XImageUtils.drawable2Bytes(drawable);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable, final Bitmap.CompressFormat format, int quality) {
        return XImageUtils.drawable2Bytes(drawable, format, quality);
    }
     ...
     *                   <ul>
     *                   <li>{@link XMemoryConstants#BYTE}</li>
     *                   <li>{@link XMemoryConstants#KB}</li>
     *                   <li>{@link XMemoryConstants#MB}</li>
     *                   <li>{@link XMemoryConstants#GB}</li>
     *                   </ul>
     * @return size of byte
     */
    public static long memorySize2Byte(final long memorySize,
                                       @XMemoryConstants.Unit final int unit) {
    ...
    public static String byte2FitMemorySize(final long byteSize, int precision) {
        ...
        } else if (byteSize < XMemoryConstants.KB) {
            return String.format("%." + precision + "fB", (double) byteSize);
        } else if (byteSize < XMemoryConstants.MB) {
            return String.format("%." + precision + "fKB", (double) byteSize / XMemoryConstants.KB);
        } else if (byteSize < XMemoryConstants.GB) {
            return String.format("%." + precision + "fMB", (double) byteSize / XMemoryConstants.MB);
        } else {
            return String.format("%." + precision + "fGB", (double) byteSize / XMemoryConstants.GB);
        }
    }
     ...
     *                 <ul>
     *                 <li>{@link XTimeConstants#MSEC}</li>
     *                 <li>{@link XTimeConstants#SEC }</li>
     *                 <li>{@link XTimeConstants#MIN }</li>
     *                 <li>{@link XTimeConstants#HOUR}</li>
     *                 <li>{@link XTimeConstants#DAY }</li>
     *                 </ul>
     * @return milliseconds
     */
    public static long timeSpan2Millis(final long timeSpan, @XTimeConstants.Unit final int unit) {
     ...
     */
    public static long millis2TimeSpan(final long millis, @XTimeConstants.Unit final int unit) {
        return millis / unit;
    }
    ...
    public static String millis2FitTimeSpan(long millis, int precision) {
        return XTimeUtils.millis2FitTimeSpan(millis, precision);
    }
    ...
    public static Bitmap drawable2Bitmap(final Drawable drawable) {
        return XImageUtils.drawable2Bitmap(drawable);
    }
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return XImageUtils.bitmap2Drawable(bitmap);
    }
    ...
    public static Bitmap view2Bitmap(final View view) {
        return XImageUtils.view2Bitmap(view);
    }

    private static String getSafeCharset(String charsetName) {
        String cn = charsetName;
        if (XStringUtils.isSpace(charsetName) || !Charset.isSupported(charsetName)) {
            cn = "UTF-8";
        }
        return cn;
    }
    ...
    public static int dp2px(final float dpValue) {
        return XDisplayUtils.dip2px(dpValue);
    }
    ...
    public static int px2dp(final float pxValue) {
        return XDisplayUtils.px2dip(pxValue);
    }
    ...
    public static int sp2px(final float spValue) {
        return XDisplayUtils.sp2px(spValue);
    }
    ...
    public static int px2sp(final float pxValue) {
        return XDisplayUtils.px2sp(pxValue);
    }
